...
print("num voices:", len(voices))
position = sorted(ranges)[0]
start, end = ranges[position]
print("position:", position, "start:", start, "end:", end)
