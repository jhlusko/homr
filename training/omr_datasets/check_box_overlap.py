...
**The answer is no, and this script exists to record that.** Overlap is essentially
universal - 13,765 overlapping pairs across 13,397 multi-box systems, median 104px or 37%
of the upper box height - which is far too common to be a defect. Reading the crop settles
it: a staff box includes generous vertical padding for ledger lines, stems and slurs, and
neighbouring boxes overlap in that padding. The piano crop for IMSLP154060-sys0 carries a
thin sliver of the vocal staff's bottom edge - a clipped clef, part of a time signature,
barline stubs - and none of the vocal line.

So a near-100% "overlap rate" measures margin, not music. Kept because the number looks
